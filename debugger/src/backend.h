...
private:
    ...
    int      fetchRemaining_;
    uint16_t fetchBasePc_ = 0;           // pc of the instruction being fetched
    bool     steppingInProgress_ = false;   // step path owns sequence/execute
    bool     freeRunSequenceStarted_ = false;
