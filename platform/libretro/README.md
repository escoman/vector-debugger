...
You can install the dll from the GUI, but you can't avoid copying the .info file manually.

## SBC handhelds and RPi

### R36S with Arkos

There's an innumerable amount of variants. I can only describe the one I've got.

1. Pick which SD card you want to use. I tend to use SD card 2, which is mounted in `/roms2'
2. Insert the card into card reader and make a folder /vector06c/cores in it. Copy some Vector-06C roms too.
...
4. Go to /roms2/vector06c/cores in the left panel. Go to /home/ark/.config/retroarch32/cores.
